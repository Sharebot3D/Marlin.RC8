...
#define CONDITIONALS_POST_H
  ...
  /**
   * Z_DUAL_ENDSTOPS || Y_DUAL_ENDSTOPS endstop reassignment
   */
  #if ENABLED(Z_DUAL_ENDSTOPS) || ENABLED(Y_DUAL_ENDSTOPS)
    #define _XMIN_ 100
    #define _YMIN_ 200
    #define _ZMIN_ 300
    #define _XMAX_ 101
  ...
  #define IS_Y2_OR_Z2_OR_PROBE(P) (P == Y2_MIN_PIN || P == Y2_MAX_PIN || P == Z2_MIN_PIN || P == Z2_MAX_PIN || P == Z_MIN_PROBE_PIN)
  ...
  #define HAS_X_MIN (PIN_EXISTS(X_MIN) && !IS_Y2_OR_Z2_OR_PROBE(X_MIN_PIN))
  #define HAS_X_MAX (PIN_EXISTS(X_MAX) && !IS_Y2_OR_Z2_OR_PROBE(X_MAX_PIN))
  #define HAS_Y_MIN (PIN_EXISTS(Y_MIN) && !IS_Y2_OR_Z2_OR_PROBE(Y_MIN_PIN))
  #define HAS_Y_MAX (PIN_EXISTS(Y_MAX) && !IS_Y2_OR_Z2_OR_PROBE(Y_MAX_PIN))
  #define HAS_Z_MIN (PIN_EXISTS(Z_MIN) && !IS_Y2_OR_Z2_OR_PROBE(Z_MIN_PIN))
  #define HAS_Z_MAX (PIN_EXISTS(Z_MAX) && !IS_Y2_OR_Z2_OR_PROBE(Z_MAX_PIN))
