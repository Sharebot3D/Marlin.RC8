...
// Add support for experimental filament exchange support M600; requires display
  ...
  #define FILAMENT_CHANGE_FEATURE             // Enable filament exchange menu and M600 g-code (used for runout sensor too)
    ...
    #define FILAMENT_CHANGE_X_POS 20            // X position of hotend
    #define FILAMENT_CHANGE_Y_POS 400           // Y position of hotend
    ...
    #define FILAMENT_CHANGE_SINGLE_EXTRUSION         // single extrusion until user clicks button or until timeout
    #if ENABLED(FILAMENT_CHANGE_SINGLE_EXTRUSION)
      #define FILAMENT_CHANGE_EXTRUSION_TIMEOUT 400
      #if ENABLED(USE_EXTERNAL_CLICK)
        #define MSG_FILAMENT_CHANGE_EXT_CLICK         "Extract Filament"
        #define MSG_FILAMENT_CHANGE_LOAD_CLICK        "Loading Filament"
        #define MSG_FILAMENT_CHANGE_EXT_STOPPED       "Extrusion stopped"
        #define MSG_FILAMENT_CHANGE_RES               "Resuming.."
      #endif
  #endif
#endif
#endif
  ...
  #define FILAMENT_DETECTION_COUNTER // enable to use an extrusion counter for delaying sensor action
  #if ENABLED(FILAMENT_DETECTION_COUNTER)
    #define FILAMENT_DETECTION_LIMIT 988
...
// Pause/Resume
#define PAUSERESUME_X_POS 20
#define PAUSERESUME_Y_POS 400
#define PAUSERESUME_Z_ADD 20
#define PAUSERESUME_XY_FEEDRATE 100
#define PAUSERESUME_Z_FEEDRATE 5
#define PAUSERESUME_RETRACT_LENGTH 3
#define PAUSERESUME_RETRACT_FEEDRATE 10
#define PAUSERESUME_UNRETRACT_FEEDRATE 3
 ...
 */
#define PREV_EEPROM_VERSION "V10"
#define PREV_EEPROM_ZPO_INDEX 208
#define PREV_EEPROM_LIFETIME_MAGIC 0x24216763
#define PREV_EEPROM_LIFETIME_OFFSET 0x700
#define CURR_EEPROM_STATS_OFFSET 0x32
